...
CREATE TABLE public.maintenance_schedules (
    ...
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    provider_id integer,
    custom_provider_name character varying(255),
    custome_type character varying(255),
    location public.geometry(Point,4326),
...
CREATE TABLE public.trips (
    ...
    CONSTRAINT check_cost_positive CHECK ((cost >= (0)::numeric)),
    CONSTRAINT check_revenue_positive CHECK ((revenue >= (0)::numeric))
);
...
ALTER TABLE ONLY public.trips
    ADD CONSTRAINT fk_driver FOREIGN KEY (driver_id) REFERENCES public.drivers(id);
